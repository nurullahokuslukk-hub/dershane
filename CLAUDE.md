---
title: Claude Code çalışma sözleşmesi
description: Bu repoda çalışan her Claude Code oturumunun uyması gereken kurallar.
status: active
updated_at: 2026-09-15
---

# Dershane Öğrenci Takip Sistemi — Claude Code Kuralları

Bu dosya her oturumun başında otomatik yüklenir. Amaç: aylarca sürecek bu projede
oturumlar arasında bağlam kaybını önlemek ve tekrar eden hataları engellemek.
...
Bunlar otomatik bir script tarafından değil, bizzat oturumu yürüten Claude tarafından
yapılır — bu proje bir "multi-agent orchestrator" çatısı değil, zaman içinde farklı
Claude Code oturumlarının aynı belgeleri okuyup güncellediği bir sistemdir. Alt-agent
